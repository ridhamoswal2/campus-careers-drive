...
1. The project uses Supabase as the backend - configure your Supabase project
2. Register as a student to test student features
3. To test admin features, update your user's role to `admin` in the database
...
After deployment:
1. Update your Supabase project settings to allow your Vercel domain in CORS
